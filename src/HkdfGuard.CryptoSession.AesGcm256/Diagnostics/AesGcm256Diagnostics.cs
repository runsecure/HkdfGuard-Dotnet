...
namespace HkdfGuard.CryptoSession.AesGcm256.Diagnostics;

/// <summary>
/// Standalone from HkdfGuard.Abstractions's HkdfDiagnostics rather than delegating to it (the way
/// HkdfGuard.Cache/DataEncryptionKey/EncryptedConfiguration do) - this project's
/// EnableSensitiveLogging toggle is its own, not shared with the rest of the library.
/// </summary>
public static class AesGcm256Diagnostics
{
    public const string SourceName = "HkdfGuard.CryptoSession.AesGcm256";
